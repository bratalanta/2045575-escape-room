* Имя студента: [Матвей Денисов](https://up.htmlacademy.ru/react/10/user/2045575)
* Время затраченное на разработку проекта: 19ч 45мин
* Из интересного:
* - Для разработки формы отправки заказа использовался хук react-hook-form
* - Исключения обработаны библиотекой react-toastify
* - Для создания карты использовалась библиотека react-leaflet
